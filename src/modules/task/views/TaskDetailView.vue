...
<template>
  <div class="min-h-screen bg-gray-50 dark-edit:bg-gray-900">
    <!-- Header -->
    <div class="sticky top-0 z-10 border-b border-gray-200 bg-white px-6 py-4 dark-edit:border-gray-700 dark-edit:bg-gray-800">
      <div class="flex items-center gap-4">
        <Button 
          ...
          @click="goBack"
        />
        <h1 class="text-lg font-semibold text-gray-900 dark-edit:text-white">
          Task Details
        </h1>
      </div>
    </div>
    ...
    <div class="mx-auto max-w-4xl p-6">
      ...
      <div v-else-if="task" class="space-y-6">
        <div class="rounded-lg bg-white p-6 shadow-sm dark-edit:bg-gray-800">
          ...
          <div 
            ...
            class="mt-4 prose prose-sm max-w-none text-gray-600 dark-edit:text-gray-400"
        ...
        <div class="rounded-lg bg-white p-6 shadow-sm dark-edit:bg-gray-800">
          <h2 class="text-lg font-semibold text-gray-900 dark-edit:text-white">Activity</h2>
