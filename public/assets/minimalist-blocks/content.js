  ...
  'snippets': [
    {
		    ...
		    'html': `
			<div class="display">
				<h1 class="font-medium">Learn the way you grow.</h1>
				<p>Empower your education with flexible learning paths.</p>
			</div>
			`	
    },
    // {
    ...
    // 		<p><span class="italic">Explore our comprehensive learning platform designed to help you achieve your educational goals.</span></p>
    // 	</div>
    // 	`	
    // },
    {
		    ...
		    'category': '120',
		    'html': `
			<p>Explore our comprehensive learning platform designed to help you achieve your educational goals. Our platform has been empowering students and educators since its launch, providing interactive courses and personalized learning paths to help you succeed in your educational journey.</p>
			`	
    },
    {
...

    {
			...
			<div class="row">
				<div class="column half">
						<p>Our platform has been empowering students and educators since its launch,
						providing interactive courses and personalized learning paths to help you succeed in your educational journey.</p>
				</div>
				<div class="column half">
						<p>Our platform has been empowering students and educators since its launch,
						providing interactive courses and personalized learning paths to help you succeed in your educational journey.</p>
        ...
        
    {
			...
			<div class="row">
				<div class="column two-third">
					<p>Explore our comprehensive learning platform designed to help you achieve your educational goals.
						Our platform has been empowering students and educators since its launch,
						providing interactive courses and personalized learning paths to help you succeed in your educational journey.</p>
				</div>
...

    {
			...
			<div class="row">
				<div class="column full">
					<h1 class="font-semibold size-42 tracking-wider">Learning Hub — We imagine, ideate, and execute with intention and drive to discover new ways of designing and detailing spaces.</h1>
				</div>
			</div>
			<div class="row">
				<div class="column full">
                    ...
                    data-html="
                            ...
                            <div id="{id}" class="is-media-grid grid-sortable" style="opacity:0">
                              <div class="gallery-item">
                                <a href="assets/minimalist-blocks/images/img-01.jpg" class="glightbox" data-title="My title" data-description="This is the description">
                                  <img src="assets/minimalist-blocks/images/img-01.jpg" alt="My title">
                                  <div class="caption">
                                    <h4>My title</h4>
                              ...
                              <div class="gallery-item">
                                <a href="assets/minimalist-blocks/images/img-02.jpg" class="glightbox" data-title="My title" data-description="This is the description">
                                  <img src="assets/minimalist-blocks/images/img-02.jpg" alt="My title">
                                  <div class="caption">
                                    <h4>My title</h4>
                                    <div>This is the description</div>
                                  </div>
                              ...
                              <div class="gallery-item">
                                <a href="assets/minimalist-blocks/images/img-03.jpg" class="glightbox" data-title="My title" data-description="This is the description">
                                  <img src="assets/minimalist-blocks/images/img-03.jpg" alt="">
                                  <div class="caption">
                                    <h4>My title</h4>
                                    <div>This is the description</div>
                                  </div>
                              ...
                              <div class="gallery-item">
                                <a href="assets/minimalist-blocks/images/img-04.jpg" class="glightbox" data-title="My title" data-description="This is the description">
                                  <img src="assets/minimalist-blocks/images/img-04.jpg" alt="My title">
                                  <div class="caption">
                                    <h4>My title</h4>
                                    <div>This is the description</div>
                                  </div>
                              ...
                              <div class="gallery-item">
                                <a href="assets/minimalist-blocks/images/img-06.jpg" class="glightbox" data-title="My title" data-description="This is the description">
                                  <img src="assets/minimalist-blocks/images/img-06.jpg" alt="My title">
                                  <div class="caption">
                                    <h4>My title</h4>
                                    <div>This is the description</div>
                                  </div>
                              ...
                              <div class="gallery-item">
                                <a href="assets/minimalist-blocks/images/img-05.jpg" class="glightbox" data-title="My title" data-description="This is the description">
                                  <img src="assets/minimalist-blocks/images/img-05.jpg" alt="My title">
                                  <div class="caption">
                                    <h4>My title</h4>
                                    <div>This is the description</div>
                                  </div>
                              ...
                              <div class="gallery-item">
                                <a href="assets/minimalist-blocks/images/img-07.jpg" class="glightbox" data-title="My title" data-description="This is the description">
                                  <img src="assets/minimalist-blocks/images/img-07.jpg" alt="My title">
                                  <div class="caption">
                                    <h4>My title</h4>
                                    <div>This is the description</div>
                                  </div>
                              ...
                              <div class="gallery-item">
                                <a href="assets/minimalist-blocks/images/img-08.jpg" class="glightbox" data-title="My title" data-description="This is the description">
                                  <img src="assets/minimalist-blocks/images/img-08.jpg" alt="My title">
                                  <div class="caption">
                                    <h4>My title</h4>
                                    <div>This is the description</div>
                                  </div>
                              ...
                              <div class="gallery-item">
                                <a href="assets/minimalist-blocks/images/img-09.jpg" class="glightbox" data-title="My title" data-description="This is the description">
                                  <img src="assets/minimalist-blocks/images/img-09.jpg" alt="My title">
                                  <div class="caption">
                                    <h4>My title</h4>
                                    <div>This is the description</div>
                                  </div>
		...
		*/
    {
			...
			<div class="row sm-autofit">
				...
				<div class="column half">
					...
					<p class="text-center">Explore our comprehensive learning platform designed to help you achieve your educational goals.&nbsp;</p>
				</div>
				<div class="column sm-hidden fourth">
					<div class="spacer height-40"></div>
				</div>
    ...
    },
    {
			...
			<div class="row">
				...
				<div style="width: 64.8476%; flex: 0 0 auto;" class="column third">
					<p class="text-center">Our platform has been empowering students and educators since its launch,
						providing interactive courses and personalized learning paths to help you succeed in your educational journey.</p>
				</div>
		...
		
    {
			...
			<div class="row">
				...
				<div class="column half flex justify-center flex-col items-center">
					<p>Our platform has been empowering students and educators since its launch, providing interactive courses and personalized learning paths to help you succeed in your educational journey.</p>
				</div>
    ...
    },
    {
			...
			<div class="row">
				<div class="column third">
					...
					<p>Our courses are designed by industry experts to provide practical, hands-on learning experiences.</p>
				</div>
				<div class="column third">
    ...
    },
    {
			...
			<div class="row">
				<div class="column third">
					...
					<p>Discover courses designed to enhance your skills and knowledge.</p>
				</div>
				<div class="column third">
					<div class="rounded-full flex justify-center items-center mb-8" style="width: 40px;height: 40px;border: 2px solid rgb(136, 136, 136);">
						<i class="icon ion-android-done leading-none size-24" style="color: rgb(136, 136, 136);"></i>
    ...
    /* Article */
    {
			...
			<div class="row">
				<div class="flex flex-col justify-center column full">
					<p>Our courses are designed by industry experts to provide practical, hands-on learning experiences. Explore our comprehensive learning platform designed to help you achieve your educational goals.&nbsp;Our courses are designed by industry experts to provide practical, hands-on learning experiences.&nbsp;</p>
					<p>Our courses are designed by industry experts to provide practical, hands-on learning experiences. Explore our comprehensive learning platform designed to help you achieve your educational goals.&nbsp;Our courses are designed by industry experts to provide practical, hands-on learning experiences. Our courses are designed by industry experts to provide practical, hands-on learning experiences.&nbsp;<br></p>
				</div>
			</div>
			`	
    },
    {
			...
			<div class="row">
				<div class="column full">
					<p class="text-justify">Explore our comprehensive learning platform designed to help you achieve your educational goals. Our platform has been empowering students and educators since its launch, providing interactive courses and personalized learning paths to help you succeed in your educational journey. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
				</div>
			</div>
			<div class="row">
				<div class="column full">
    ...
    },
    {
			...
			<div class="row relative sm-items-1">
				<div class="py-6 flex flex-col justify-center column third">
					<h1 class="leading-none size-28 font-normal">Innovative Learning, Great Achievement.</h1>
					<div class="spacer height-20"></div>
					<p>Our platform has been empowering students and educators since its launch,
						providing interactive courses and personalized learning paths to help you succeed in your educational journey.</p>
				</div>
    ...
    },
    {
			...
			<div class="row">
				<div class="column half">
					<p class="text-justify">Start your learning journey with courses designed for all skill levels. Our platform offers interactive and engaging educational content tailored to your needs.</p>
				</div>
				<div class="column half">
					<p class="text-justify">Start your learning journey with courses designed for all skill levels. Our platform offers interactive and engaging educational content tailored to your needs.</p>
				</div>
    ...
    },
    {
			...
			<div class="row">
				<div class="column half" style="width: 100%;">
					<p class="italic" style="color: rgb(138, 138, 138);">Our platform has been empowering students and educators since its launch,
						providing interactive courses and personalized learning paths to help you succeed in your educational journey.</p>
    ...
    },
    {
			...
			<div class="row">
				<div class="column half">
					<p class="text-justify">Our platform has been empowering students and educators since its launch, providing interactive courses and personalized learning paths to help you succeed in your educational journey. Lorem ipsum dolor sit amet. Vivamus ante.</p>
				</div>
				<div class="column half">
					<p class="text-justify">Our platform has been empowering students and educators since its launch, providing interactive courses and personalized learning paths to help you succeed in your educational journey. Lorem ipsum dolor sit amet. Vivamus ante.</p>
				</div>
    ...
    },
    {
			...
			<div class="row">
				<div class="column third" style="width: 36.7206%; flex: 0 0 auto;">
					<h3 class="size-42 font-normal leading-11">Innovative Learning, Great Achievement.</h3>
					<p class="size-17 leading-14" style="color: rgb(145, 145, 145);">Through dedicated learning, we’ll achieve our goals and unlock endless opportunities.</p>
				</div>
    ...
    },
    {
			...
			<div class="row relative md-items-2">
				...
				<div class="column third">
					<p class="text-left">Explore our comprehensive learning platform designed to help you achieve your educational goals.
						Our platform has been empowering students and educators since its launch,
						providing interactive courses and personalized learning paths to help you succeed in your educational journey.</p>
				</div>
				<div class="column third">
					<p class="text-left">Explore our comprehensive learning platform designed to help you achieve your educational goals.
						Our platform has been empowering students and educators since its launch,
						providing interactive courses and personalized learning paths to help you succeed in your educational journey.</p>
					<p class="text-left">Our platform has been empowering students and educators since its launch,
						providing interactive courses and personalized learning paths to help you succeed in your educational journey.</p>
				</div>
			</div>
			`	
    },
    {
			...
			<div class="row md-autofit sm-autofit">
				<div class="column half">
					<p class="text-left">Explore our comprehensive learning platform designed to help you achieve your educational goals. Our platform has been empowering students and educators since its launch, providing interactive courses and personalized learning paths to help you succeed in your educational journey. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
				</div>
    ...
    },
    {
			...
			<div class="row">
				<div class="column half">
					<p class="text-justify">Explore our comprehensive learning platform designed to help you achieve your educational goals. Our platform offers interactive and engaging educational content tailored to your needs.</p>
					<p class="text-justify">Our platform has been empowering students and educators since its launch, providing interactive courses and personalized learning paths to help you succeed in your educational journey.</p>
				</div>
				<div class="column half">
					<p class="text-justify">Explore our comprehensive learning platform designed to help you achieve your educational goals. Our platform offers interactive and engaging educational content tailored to your needs.</p>
					<p class="text-justify">Our platform has been empowering students and educators since its launch, providing interactive courses and personalized learning paths to help you succeed in your educational journey.</p>
			...
			<div class="row">
				...
				<div class="column half" style="width: 54.0445%; flex: 0 0 auto;">
					...
					<p>Our platform has been empowering students and educators since its launch,
						providing interactive courses and personalized learning paths to help you succeed in your educational journey.</p>
					<p>Explore our comprehensive learning platform designed to help you achieve your educational goals.
						Our courses are designed by industry experts to provide practical, hands-on learning experiences.</p>
				</div>
			</div>
			`	
    },
    ...
    },
    {
			...
			<div class="row md-autofit sm-autofit">
				...
				<div class="column fourth" style="width: 100%;">
					<p>Explore our comprehensive learning platform designed to help you achieve your educational goals.&nbsp;</p>
				</div>
				<div class="column fourth" style="width: 100%;">
					<p>Explore our comprehensive learning platform designed to help you achieve your educational goals.
						Our platform has been empowering students and educators since its launch,
    ...
    },
    {
			...
			<div class="row">
				<div class="column half">
					<p class="text-left">Discover courses designed to enhance your skills and knowledge. Our courses are designed by industry experts to provide practical, hands-on learning experiences.</p>
				</div>
				<div class="column half">
					<p class="text-left">Discover courses designed to enhance your skills and knowledge. Our courses are designed by industry experts to provide practical, hands-on learning experiences.</p>
				</div>
    ...
    },
    {
			...
			<div class="row">
				<div class="column full center">
					...
					<p><span class="italic">Comprehensive learning resources</span></p>
				</div>
			</div>
			`	
    },
...

    {
			...
			<div class="row">
				...
				<div style="width: 60.2224%; flex: 0 0 auto;" class="column half">
					<p class="text-center" style="color: rgb(102, 102, 102);">Explore our comprehensive learning platform designed to help you achieve your educational goals.</p>
				</div>
				<div class="xs-hidden column fourth" style="width: 100%;">
					<div class="spacer height-20"></div>
				</div>
    ...
    },
    {
			...
			<div class="row">
				<div class="column full">
					<h1 class="leading-none font-normal size-54">Our platform has been empowering students and educators since its launch,
						when an unknown printer took a galley of type.</h1>
				</div>
			</div>
			<div class="row">
				<div class="column full">
			...
			<div class="row">
				<div class="column full">
					<p style="color: rgb(102, 102, 102);">Our platform has been empowering students and educators since its launch,
    ...
    },
    {
			...
			<div class="row">
				<div style="width: 67.5072%; flex: 0 0 auto;" class="column half">
					<h1 class="normal-case font-light tracking-tight leading-none size-50"><span class="font-semibold size-50">We're [Your LMS].</span><br class="size-50">Mobile app development with a spark of creativity.</h1>
					<div class="spacer height-40"></div>
					<div>
...
"><i class="icon ion-android-arrow-dropright-circle mr-3 size-50"></i> Show Reel</a>
    ...
    },
    {
			...
			<div class="row">
				<div class="column third"><img src="assets/minimalist-blocks/images/img-1350x900.png" alt="">
					...
					<p>Comprehensive learning resources for your success</p>
				</div>
				<div class="column third"><img src="assets/minimalist-blocks/images/img-1350x900.png" alt="">
    ...
    },
    {
			...
			<div class="row">
				<div class="column half py-4">
					...
					<p style="max-width: 400px;">Explore our comprehensive learning platform designed to help you achieve your educational goals.</p>
					<div class="is-social text-left">
						<a href="https://twitter.com/"><i class="bi bi-twitter-x" style="margin-right: 1em"></i></a>
						<a href="https://www.facebook.com/"><i class="bi bi-facebook" style="margin-right: 1em"></i></a>
						<a href="mailto:you@example.com"><i class="bi bi-envelope"></i></a>
    ...
    },
    {
			...
			<div class="row">
				...
				<div class="px-3 flex flex-col justify-center column two-third">
					...
					<p style="color: rgb(109, 109, 109);">Discover courses designed to enhance your skills and knowledge.</p>
    ...
    },
    {
			...
			<div class="row">
				<div class="column third"><img src="assets/minimalist-blocks/images/img-1350x1350.png" alt="">
					...
					<p>Start your learning journey with courses designed for all skill levels.</p>
				</div>
				<div class="column third"><img src="assets/minimalist-blocks/images/img-1350x1350.png" alt="">
    ...
    },
    {
			...
			<div class="row">
				<div class="flex flex-col justify-center column half">
					...
					<p>Our courses are designed by industry experts to provide practical, hands-on learning experiences. Comprehensive learning resources.</p>
    ...
    },
    {
			...
			<div class="row">
				...
				<div class="flex flex-col justify-center items-center column half">
					...
					<div class="spacer height-20"></div>
					<p class="text-center">Our courses are designed by industry experts to provide practical, hands-on learning experiences. Comprehensive learning resources.</p>
					<div class="spacer height-20"></div>
    ...
    },
    {
			...
			<div class="row">
				...
				<div class="flex flex-col justify-center items-end column half">
					...
					<p class="text-justify">Explore our comprehensive learning platform designed to help you achieve your educational goals. Our courses are designed by industry experts to provide practical, hands-on learning experiences.</p>
    ...
    },
    {
			...
			<div class="column third py-4"><img src="assets/minimalist-blocks/images/img-900x900.png" alt="">
				...
				<p class="leading-13">Our platform has been empowering students and educators since its launch,
    ...
    },
    {
			...
			<div class="row">
				<div class="column half flex flex-col justify-center items-start" style="width: 100%;">
					...
					<div class="spacer height-20"></div>
					<p>Explore our comprehensive learning platform designed to help you achieve your educational goals. Our courses are designed by industry experts to provide practical, hands-on learning experiences.</p>
				</div>
    ...
    },
    {
			...
			<div class="row">
				...
				<div class="column" style="width: 50%; flex: 0 0 auto;">
					...
					<p class="text-justify leading-13">Explore our comprehensive learning platform designed to help you achieve your educational goals with personalized learning paths.</p>
    ...
    },
    {
			...
			<div class="row">
				<div class="column half pb-3" style="width: 100%;">
					...
					<div class="spacer height-20"></div>
					<p class="text-justify leading-13">Our platform has been empowering students and educators since its launch, when an unknown printer took.</p>
    ...
    },
    {
			...
			<div class="row">
				...
				<div style="width: 64.8476%; flex: 0 0 auto;" class="column third">
					<p class="text-center leading-13">Our platform has been empowering students and educators since its launch,
						providing interactive courses and personalized learning paths to help you succeed in your educational journey.</p>
				</div>
				<div class="column third" style="width: 100%;">
					<div class="spacer height-40"></div>
    ...
    },
    {
			...
			<div class="row">
				<div class="column fourth">
					...
					<p class="text-center leading-13" style="color: rgb(102, 102, 102);">Explore our comprehensive learning platform designed to help you achieve your educational goals.&nbsp;</p>
				</div>
				<div class="column fourth">
					<div class="text-center">
			...
			<div class="row">
				<div class="column third">
					<div class="list">
						...
						<p style="margin: 5px 0 0 50px;  font-weight: 300" class="leading-13">Discover courses designed to enhance your skills and knowledge.</p>
					</div>
				</div>
				<div class="column third">
					<div class="list">
    ...
    },
    {
			...
			<div class="row">
				<div class="column fourth"><i class="icon ion-android-bulb size-32" style="color: rgb(174, 174, 174);"></i>
					...
					<p class="leading-13">Access quality educational content for lifelong learning.</p>
				</div>
    ...
    },
    {
			...
			<div class="row">
				<div class="column third">
					...
					<p style="color: rgb(102, 102, 102);">Explore our comprehensive learning platform designed to help you achieve your educational goals.</p>
				</div>
				<div class="column third">
    ...
    },
    {
			...
			<div class="row">
				<div class="column third center">
					...
					<p class="size-16" style="color: rgb(102, 102, 102);">Discover courses designed to enhance your skills and knowledge.</p>
				</div>
				<div class="column third center">
    ...
    },
    {
			...
			<div class="row">
				<div class="column third">
					...
					<p class="text-left">Discover courses designed to enhance your skills and knowledge. Vivamus leo ante, dolor sit amet vel.</p>
				</div>
				<div class="column third">
					<h1 class="size-54 text-center">02</h1>
					<p>Discover courses designed to enhance your skills and knowledge. Vivamus leo ante, dolor sit amet vel.</p>
				</div>
				<div class="column third">
    ...
    },
    {
			...
			<div class="row">
				<div class="column half">
					...
					<p>Discover courses designed to enhance your skills and knowledge. Our courses are designed by industry experts to provide practical, hands-on learning experiences.</p>
				</div>
    ...
    },
    {
			...
			<div class="row">
				<div class="column two-third">
					<p class="size-16 text-justify" style="color: rgb(102, 102, 102);">Explore our comprehensive learning platform designed to help you achieve your educational goals. Our platform has been empowering students and educators since its launch, providing interactive courses and personalized learning paths to help you succeed in your educational journey.</p>
				</div>
				<div class="column third">
					<div class="spacer height-80"></div>
				</div>
    ...
    },
    {
			...
			<div class="row">
				...
				<div class="column half">
					<p><span class="font-semibold">1. Tell us what you need.</span> Our courses are designed by industry experts to provide practical, hands-on learning experiences.</p>
					<p><span class="font-semibold">2. Solution offer.</span> Our courses are designed by industry experts to provide practical, hands-on learning experiences.</p>
					<p><span class="font-semibold">3. Planning &amp; design.</span> Explore our comprehensive learning platform designed to help you achieve your educational goals.</p>
					<p><span class="font-semibold">4. Implementing &amp; maintenance.</span> Explore our comprehensive learning platform designed to help you achieve your educational goals.</p>
				</div>
			</div>
			`	
    },
    {
			...
			<div class="row">
				<div class="column fourth"><i class="icon ion-ios-lightbulb-outline size-42"></i>
					...
					<p class="size-14">Discover courses designed to enhance your skills and knowledge.</p>
				</div>
    ...
    },
    {
			...
			<div class="row">
				<div class="column half">
					...
					<p style="color: rgb(102, 102, 102);" class="size-16 text-justify">Explore our comprehensive learning platform designed to help you achieve your educational goals with expert-led courses.</p>
				</div>
				<div class="column half">
    ...
    /* Pricing */
    {
			...
			<div class="row">
				...
				<div style="width: 52.7981%; flex: 0 0 auto;" class="column third text-center">
					...
					<div class="spacer height-20"></div>
					<p style="color: rgb(109, 109, 109);" class="text-center size-14">Our platform has been empowering students and educators since its launch,
						providing interactive courses and personalized learning paths to help you succeed in your educational journey.</p>
				</div>
				<div class="column third xs-hidden" style="width: 100%;">
					<div class="spacer height-80"></div>
			...
			<div class="row relative sm-items-2">
				<div class="column third flex flex-col justify-center items-center py-4">
					<div style="width: 100%; padding: 50px 30px; box-sizing: border-box; max-width: 450px;" class="is-card shadow-1 text-left flex justify-center flex-col items-center">
						...
						<p style="color: rgb(123, 123, 123);">Our courses are designed by industry experts to provide practical, hands-on learning experiences.</p>
			...
			<div class="row relative">
				<div class="flex flex-col justify-center items-center column half py-4">
					<div style="width: 100%; padding: 50px 30px; box-sizing: border-box; max-width: 450px;" class="is-card shadow-1 text-left flex justify-center flex-col items-center">
						...
						<p style="color: rgb(123, 123, 123);">Our platform has been empowering students and educators since its launch</p>
    ...
    },
    {
			...
			<div class="row relative">
				<div class="column third pr-9 py-5">
					...
					<div class="spacer height-20"></div>
					<ul style="list-style: initial;padding-left: 20px;">
						<li class="leading-14">Explore our comprehensive learning platform designed to help you achieve your educational goals.</li>
						<li class="leading-14">Explore our comprehensive learning platform designed to help you achieve your educational goals.</li>
					</ul>
					<div class="spacer height-40"></div>
					<div>
    ...
    },
    {
			...
			<div class="row md-autofit">
				<div class="py-5 column third" style="width: 100%;">
					...
					<div class="spacer height-20"></div>
					<p style="color: rgb(123, 123, 123);">Explore our comprehensive learning platform designed to help you achieve your educational goals.</p>
					<ul style="list-style: initial;padding-left: 20px;">
						<li>Feature One</li>
						<li>Feature Two</li>
						<li>Feature Three</li>
    ...
    },
    {
			...
			<div class="row">
				<div class="column third" style="width: 100%;">
					...
					<p>Access quality educational content for lifelong learning. Our courses are designed by industry experts to provide practical, hands-on learning experiences.</p>
					<ul style="list-style: initial;padding-left: 20px;">
						<li>Feature One</li>
						<li>Feature Two</li>
					</ul>
    ...
    },
    {
			...
			<div class="row">
				<div class="column third">
					...
					<p style="color: rgb(102, 102, 102);">Discover courses designed to enhance your skills and knowledge.</p>
				</div>
				<div class="column third">
					<div class="text-left">
						<i class="icon ion-ios-gear-outline size-42"></i>
    ...
    },
    {
			...
			<div class="row relative">
				<div class="column third px-10">
					...
					<p style="color: rgb(102, 102, 102);" class="text-center leading-13">Explore our comprehensive learning platform designed to help you achieve your educational goals.</p>
				</div>
				<div class="column third px-10">
    ...
    },
    {
			...
			<div class="row">
				<div class="column third pr-10">
					...
					<p style="color: rgb(102, 102, 102);">Our courses are designed by industry experts to provide practical, hands-on learning experiences.</p>
				</div>
				<div class="column third pr-10">
					<div style="width: 120px; height: 120px; border-radius: 50%; border: 3px solid rgb(51, 51, 51); display: inline-block;" class="text-center">
    ...
    },
    {
			...
			<div class="row">
				<div class="center column third"><i class="icon ion-ios-heart-outline size-42"></i>
					...
					<p class="text-center leading-13">Explore our comprehensive learning platform designed to help you achieve your educational goals.</p>
				</div>
    ...
    },
    {
			...
			<div class="row">
				<div class="column third"><i class="icon ion-ios-lightbulb-outline size-35"></i>
					<h4 class="font-normal size-19">UI/UX</h4>
					<p>Access quality educational content for lifelong learning.</p>
				</div>
    ...
    },
    {
			...
			<div class="row">
				<div class="column third">
					...
					<p class="text-center leading-13" style="color: rgb(109, 109, 109);">Explore our comprehensive learning platform designed to help you achieve your educational goals.</p>
				</div>
				<div class="column third">
    ...
    },
    {
			...
			<div class="row">
				<div class="column third">
					...
					<div class="spacer height-20"></div>
					<p style="color: rgb(109, 109, 109);" class="leading-13">Discover courses designed to enhance your skills and knowledge.</p>
				</div>
				<div class="column third">
					<div class="text-left leading-14">
    ...
    },
    {
			...
			<div class="row">
				<div class="column third">
					...
					<p style="margin-top: 0px; color: rgb(158, 158, 158);" class="size-16 leading-13">Access quality educational content for lifelong learning.</p>
				</div>
				<div class="column third">
    ...
    },
    {
			...
			<div class="row">
				<div class="column half">
					...
					<p class="size-16" style="color: rgb(158, 158, 158);">Join thousands of learners who have transformed their careers through our comprehensive learning programs.</p>
				</div>
    ...
    },
    {
			...
			<div class="row">
				<div class="column third">
					...
					<p style="color: rgb(109, 109, 109);">Our courses are designed by industry experts to provide practical, hands-on learning experiences.</p>
				</div>
				<div class="column third">
    ...
    },
    {
			...
			<div class="row">
				<div class="column full">
					<h1 class="size-32 leading-11">[Learning Platform] provide us with a forward thinking and well placed service. This has made significant impact on the efficiency and stability of our network.</h1>
				</div>
    ...
    },
    {
			...
			<div class="row">
				<div class="flex flex-col justify-center column two-third">
					<h2 class="font-normal leading-11 size-32">"Transform your learning experience with our comprehensive educational platform"</h2>
				</div>
    ...
    },
    {
			...
			<div class="row">
				<div class="text-center flex flex-col justify-center items-center column third"><img src="assets/minimalist-blocks/images/img-700x700.png" alt="" style="border-radius: 500px; width: 65%; height: auto;">
					<div class="spacer height-20"></div>
					<h3 class="size-19 font-light">"Transform your learning experience with our comprehensive educational platform"</h3>
    ...
    },
    {
			...
			<div class="row">
				...
				<div class="flex flex-col justify-center column half">
					<p class="leading-14">"Explore our comprehensive learning platform designed to help you achieve your educational goals.
						Our platform has been empowering students and educators since its launch,
    ...
    },
    {
			...
			<div class="row">
				<div class="column half">
					<h2 class="leading-none size-32">I highly recommend [Your LMS]. I got a brand identity that truly feels timeless and impressive.</h2>
					<div class="spacer height-20"></div>
    ...
    },
    {
			...
			<div class="row">
				<div class="column half flex flex-col justify-center items-start">
					...
					<div class="spacer height-20"></div>
					<p>Our courses are designed by industry experts to provide practical, hands-on learning experiences. <a href="#" title="">Read the Success Story</a></p>
				</div>
    ...
    },
    {
			...
			<div class="row sm-autofit">
				...
				<div class="column third">
					...
					<div class="spacer height-20"></div>
					<p class="text-center" style="color: rgb(109, 109, 109);">Our courses are designed by industry experts to provide practical, hands-on learning experiences.</p>
    ...
    },
    {
			...
			<div class="row sm-autofit">
				...
				<div class="p-10 column third">
					<p class="text-left" style="color: rgb(109, 109, 109);">Our platform has been empowering students and educators since its launch,
						providing interactive courses and personalized learning paths to help you succeed in your educational journey.</p>
    ...
    /* FAQ */
    {
			...
			<div class="row">
				<div class="column half">
					...
					<div class="spacer height-20"></div>
					<p style="color: rgb(72, 72, 72);">Our platform has been empowering students and educators since its launch,
						providing interactive courses and personalized learning paths to help you succeed in your educational journey.</p>
				</div>
				<div class="column half">
    ...
    },
    {
			...
			<div class="row">
				<div class="column half">
					...
					<h2 class="size-21 font-normal">What does [Your LMS] do?</h2>
					<p style="color: rgb(72, 72, 72);">Explore our comprehensive learning platform designed to help you achieve your educational goals.
						Our platform has been empowering students and educators since its launch,
						when an unknown printer took a galley of type.</p>
				</div>
				...
				<div class="column half">
					...
					<h2 class="size-21 font-normal">How [Your LMS] helps your business?</h2>
					<p style="color: rgb(72, 72, 72);">Explore our comprehensive learning platform designed to help you achieve your educational goals.
						Our platform has been empowering students and educators since its launch,
						when an unknown printer took a galley of type.</p>
				</div>
    ...
    },
    {
			...
			<div class="row">
				<div class="column half" style="width: 67.1948%; flex: 0 0 auto;">
					<h2 class="size-21 font-medium">How [Your LMS] helps your business.</h2>
					<p>Our platform has been empowering students and educators since its launch,
						providing interactive courses and personalized learning paths to help you succeed in your educational journey.</p>
				</div>
				<div class="column half xs-hidden" style="width: 100%;">
    ...
    },
    {
			...
			<div class="row">
				<div class="column third">
					...
					<h3 class="size-21 font-normal">What services does [Your LMS] offer?</h3>
					<p class="leading-14">Our platform has been empowering students and educators since its launch,
						providing interactive courses and personalized learning paths to help you succeed in your educational journey.</p>
				</div>
				<div class="column third">
					<div class="text-left">
					...
					<h3 class="size-21 font-normal">Why should we choose [Your LMS]?</h3>
					<p class="leading-14">Our platform has been empowering students and educators since its launch,
						providing interactive courses and personalized learning paths to help you succeed in your educational journey.</p>
				</div>
				<div class="column third">
    ...
    },
    {
			...
			<div class="row">
				...
				<div class="column two-third" style="width: 66.7237%; flex: 0 0 auto;">
					<h2 class="size-24 font-medium">What does [Your LMS] do?</h2>
					<p class="leading-14">Explore our comprehensive learning platform designed to help you achieve your educational goals.
						Our platform has been empowering students and educators since its launch,
						providing interactive courses and personalized learning paths to help you succeed in your educational journey.</p>
				</div>
			...
			<div class="row">
				<div style="width: 39.8631%; flex: 0 0 auto;" class="column half">
					<h2 class="size-24 font-medium">Why should we choose [Your LMS]?</h2>
					<p class="leading-14">Our platform has been empowering students and educators since its launch,
						providing interactive courses and personalized learning paths to help you succeed in your educational journey.</p>
				</div>
				<div class="column half xs-hidden" style="width: 100%;">
    ...
    },
    {
			...
			<div class="row">
				...
				<div class="column half">
					<p class="text-justify leading-14">Explore our comprehensive learning platform designed to help you achieve your educational goals. Our courses are designed by industry experts to provide practical, hands-on learning experiences.</p>
				</div>
			...
			<div class="row">
				...
				<div class="column half">
					<p class="text-justify leading-14">Explore our comprehensive learning platform designed to help you achieve your educational goals.</p>
				</div>
    ...
    },
    {
			...
			<div class="row">
				<div class="column half"><i class="icon ion-android-cart size-28" style="color: rgb(174, 174, 174);"></i>
					...
					<p style="color: rgb(138, 138, 138); max-width: 600px;">Explore our comprehensive learning platform designed to help you achieve your educational goals.</p>
				</div>
			...
			<div class="row">
				...
				<div class="column half"><i class="icon ion-arrow-swap size-28" style="color: rgb(174, 174, 174);"></i>
					...
					<p style="color: rgb(138, 138, 138); max-width: 600px;">Access quality educational content.</p>
				</div>
			</div>
			`	
    },
    ...
    },
    {
			...
			<div class="row">
				<div style="width: 46.8539%; flex: 0 0 auto;" class="column half">
					...
					<p style="color: rgb(109, 109, 109);">Our platform has been empowering students and educators since its launch,
						providing interactive courses and personalized learning paths to help you succeed in your educational journey.</p>
					<div class="is-social text-left">
						<a href="https://twitter.com/"><i class="bi bi-twitter-x" style="margin-right: 1em"></i></a>
						<a href="https://www.facebook.com/"><i class="bi bi-facebook" style="margin-right: 1em"></i></a>
    ...
    /*  About */
    {
			...
			<div class="row">
                ...
                <div class="row">
                    ...
                    <div class="column two-third">
                        <p style="margin-top: 0px;" class="text-justify">Explore our comprehensive learning platform designed to help you achieve your educational goals. Our courses are designed by industry experts to provide practical, hands-on learning experiences.</p>
                        <p class="text-justify">Explore our comprehensive learning platform designed to help you achieve your educational goals. Our platform has been empowering students and educators since its launch, providing interactive courses and personalized learning paths to help you succeed in your educational journey.</p>
                    </div>
		...
		
    {
			...
			<div class="row">
				<div class="column third">
					<p class="text-justify">Explore our comprehensive learning platform designed to help you achieve your educational goals. Our platform has been empowering students and educators since its launch, when an unknown printer took a galley of type and scrambled it.</p>
				</div>
				<div class="column two-third"><img src="assets/minimalist-blocks/images/img-1920x1280.png" alt=""></div>
		...
		
    {
			...
			<div class="row">
				<div class="column full">
					<h1 class="size-42 font-semibold tracking-wide">Hello, we are [Learning Platform]. We are a team of passionate design-thinkers &amp; product strategist.</h1>
					<p style="color: rgb(138, 138, 138); font-family: serif; font-style: italic;" class="size-18">Explore our comprehensive learning platform designed to help you achieve your educational goals.</p>
				</div>
			...
			<div class="row">
				<div class="column half">
					<p class="text-justify">Explore our comprehensive learning platform designed to help you achieve your educational goals. Join thousands of learners who have transformed their careers through our comprehensive learning programs.</p>
				</div>
				<div class="column half">
					<p class="text-justify">Explore our comprehensive learning platform designed to help you achieve your educational goals. Join thousands of learners who have transformed their careers through our comprehensive learning programs.</p>
				</div>
		...
		
    {
			...
			<div class="row">
				...
				<div class="column half flex flex-col justify-center items-start">
					...
					<div class="spacer height-20"></div>
					<p class="text-justify">Our platform has been empowering learners with quality educational content, interactive courses, and personalized learning paths designed for success.</p>
					<p class="text-justify">Our platform has been empowering learners with quality educational content and personalized learning paths.</p>
				</div>
		...
		
    {
			...
			<div class="row">
				<div style="padding-right: 30px;" class="column third">
					...
					<p style="color: rgb(102, 102, 102);" class="size-16 text-justify">Join thousands of learners who have transformed their careers through our comprehensive learning programs.</p>
				</div>
		...
		
    {
			...
			<div class="row">
				<div class="column half">
					<p class="font-semibold text-justify">Explore our comprehensive learning platform designed to help you achieve your educational goals.</p>
					<div class="spacer height-20"></div>
					<p class="text-justify">Explore our comprehensive learning platform designed to help you achieve your educational goals. Our platform has been empowering students and educators since its launch, providing interactive courses and personalized learning paths to help you succeed in your educational journey. It has survived not only five centuries.</p>
				</div>
				<div class="column half"><img src="assets/minimalist-blocks/images/img-1350x1350.png" alt=""></div>
...

    {
			...
			<div class="row">
				...
				<div class="column third">
					...
					<p class="leading-13">Explore our comprehensive learning platform designed to help you achieve your educational goals.
						Our courses are designed by industry experts to provide practical, hands-on learning experiences.</p>
				</div>
				<div class="column third">
					<div class="spacer height-100"></div>
